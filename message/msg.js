...
module.exports = async(conn, msg, m, setting, store) => {
    ...
    const readmore = more.repeat(4001)
		...
		const buttonsDefault = [
			...
			{ urlButton: { displayText: `Nomer Owner`, url : `https://wa.me/6281584240439?text=Hai+kak+aku+mau+beli+PREMIUM` } },
			{ quickReplyButton: { displayText: `💰 Donasi`, id: `${prefix}donate` } },
			{ quickReplyButton: { displayText: `Script`, id: `${prefix}sc` } },
		]
		const button5 = [
			{ callButton: { displayText: `Number Owner`, phoneNumber: `6281584240439` } },
...
conn.sendMessage(from, { caption: teks, image: fs.readFileSync('media/Hap.jpg'), templateButtons: buttonsDefault, footer: '© Gris Bltz', mentions: [sender]} )
				break
case prefix+'delete':
  case prefix+'d':
    case prefix+'del':
...
case prefix+'sewa':
  ...
  var teks = `*[ LIST HARGA Gris Bltz PREM ]*
  ...
  Note : Donasi Seikhlasnya`)
			...
			case prefix+'owner':
			    for (let x of ownerNumber) {
			      sendContact(from, x.split('@s.whatsapp.net')[0], 'Fariss', msg)
			    }
...
conn.sendMessage(`6281584240439@s.whatsapp.net`, {text: `*[ PANGGILAN USER ]*\n\n*Dari :* @${sender}\n*Pesan :* ${q}`, mentions: [sender]})
break
case prefix+'gombal':
